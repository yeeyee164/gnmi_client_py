...
class GNMISession:
    ...
    def __init__(self, target_ip, target_port, paths, mode, data_queue, username="", password="", prefix="", encoding="json_ietf", **kwargs):
    ...
    def start(self):
        ...
        print(f"[Worker {self.target_ip}] Starting {self.mode.upper()} session...")
        ...
        try:
            ...
            print(f"[Worker {self.target_ip}] Error: {e}")
        finally:
            print(f"[Worker {self.target_ip}] Disconnected.")
